 ...
 * immutable, however via the {@link AttributesCollection.Builder} supports
...
public final class AttributesCollection implements Iterable<Attribute> {
  ...
  /**
   * Returns a new {@link AttributesCollection.Builder} preloaded with the
  ...
  /**
   * Returns a new {@link AttributesCollection.Builder}, useful for building an
